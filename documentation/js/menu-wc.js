                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-3ed1d5bd797d46738f4bbd876bd0b4ff"' : 'data-target="#xs-components-links-module-AppModule-3ed1d5bd797d46738f4bbd876bd0b4ff"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-3ed1d5bd797d46738f4bbd876bd0b4ff"' :
                                            'id="xs-components-links-module-AppModule-3ed1d5bd797d46738f4bbd876bd0b4ff"' }>
                                            <li class="link">
                                                <a href="components/AppComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">AppComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/DetalleComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DetalleComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/NuevaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">NuevaComponent</a>
                                            </li>
                                            <li class="link">
                                    ...
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#pipes-links-module-AppModule-3ed1d5bd797d46738f4bbd876bd0b4ff"' : 'data-target="#xs-pipes-links-module-AppModule-3ed1d5bd797d46738f4bbd876bd0b4ff"' }>
                                            <span class="icon ion-md-add"></span>
                                            <span>Pipes</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="pipes-links-module-AppModule-3ed1d5bd797d46738f4bbd876bd0b4ff"' :
                                            'id="xs-pipes-links-module-AppModule-3ed1d5bd797d46738f4bbd876bd0b4ff"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="guards-links"' : 'id="xs-guards-links"' }>
                            <li class="link">
                                <a href="guards/ProdGuardsService.html" data-type="entity-link">ProdGuardsService</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
